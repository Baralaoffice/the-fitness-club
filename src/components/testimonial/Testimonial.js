      ...
      <Box className={classes.row}>
        <Box className={classes.col_l}>
          ...
          <Typography variant="h6">
            {TestimonialsData[selector].name} <span>- {TestimonialsData[selector].status}</span>
          </Typography>
        </Box>
        <Box className={classes.col_r}>
          ...
          <Box className={classes.arrow}>
            <img src="./img/download (7).png" alt="" onClick={() => {
              selector === 0
                ? setselector(Tleanth - 1)
